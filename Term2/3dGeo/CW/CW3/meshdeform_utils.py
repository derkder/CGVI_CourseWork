...
def mesh_deformation(control_points_indices = None, handle_point_index = None, displacements = None, mesh = None, isManually = False):
    ...
    if(isManually):
        boundary_ctrl_pts = control_points_indices
    else:
    ...
    b3[0] = V[glo2sub[handle_pt], 0] + displacements[0]
    b3[1] = V[glo2sub[handle_pt], 1] + displacements[1]
    b3[2] = V[glo2sub[handle_pt], 2] + displacements[2]
